...
var mapStyle = [ //I call this style, 'ice, if ice was sexy' -Taylor
  {
...
var tempMarkers = [{
    sales: '1',
    aftersales: '0',
    name: 'Center of Tally',
    lat: '30.43',
    lon: '-84.285',
    adr: 'Some Address',
    pc: 'In Some Place',
    tel: '(850) - 555 - 1234',
    url: 'www.tallahassee.gov',
    avr: '',
    position: '1'
},
{
    ...
    name: 'my house',
    lat: '30.438329',
    lon: '-84.29116599999998',
    adr: '608 west lafayette',
    pc: 'tallahassee',
    tel: '(850) - 376 - 9263',
    url: 'www.drinkr.io',
    avr: '',
    ...
    return {
        ...
        link: function (scope, element, attrs) {
			...
			function createMap() {
				...
				var mapOptions = {
					zoom: 13,
					center: new google.maps.LatLng(30.43, -84.285),
			...
			function updateMarkers() {
				if (map && scope.markers) {
					...
					for (var i = 0; i < markers.length; i++) {
						...
						var mm = new google.maps.Marker({ position: loc, map: map, title: m.name,icon: 'images/smaller_Beermug.png'});
